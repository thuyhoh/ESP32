...
int mqtt_port = 1883; // esp kết nối mqtt => TCP
String topicsub = "subdata"; // nhận dữ liệu ESP ở topic toannv10291/quat => APP WEB gửi toannv10291/quat
String topicpub = "pubdata"; // gửi dữ liệu
...
/*
 * ngày tháng năm hiện tại - 1970 1 1 => (ngày - 1)* 86400 + số giây hiện ngày đó nữa
 * 
 * 2021 - 1970 = 51*365 =  => ngày*86400 = a = 1608336000
 * 
 * (2021 - 1970) / 4 = 13 * 86400 = b = 1123200
 * 
 * 22h30 = 22*3600 + 30*60  =>  c = 81000
 * 
 * d = a + b + c = 1,609,540,200 -  86400 = 1,611,071,093 1,609,453,800
 * 
 * giờ phút giây => giây tổng
 */
